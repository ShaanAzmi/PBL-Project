...
export const languages: LanguageOption[] = [
  ...
  { code: 'mni', name: 'Manipuri', nativeName: 'মৈতৈলোন্', flag: 'MN' },
  { code: 'garo', name: 'Garo', nativeName: 'A·chik', flag: 'GR' }
]
...
const getTranslations = () => ({
  ...
  mni: {
    ...
    // Home Page
    'home.title': 'রোগ নিরীক্ষণ অমসুং থিংবা',
    'home.subtitle': 'সমগ্র ভারত কভারেজ',
    'home.description': 'প্রধান রোগ প্রাদুর্ভাব থিংবদা লৌমি অমসুং থবক শিজিন্নদুনা ভারতগী কমিউনিতিশিংবু মতিক চাবা। খুদক্তা নাতোন পরখবা, থিংবগী মতাংদা লৌবা অমসুং দেশব্যাপী স্বাস্থ্য সেবাগী রিসোর্স ফংবা।',
